package com.alim.taskflow.features.editTask
...
class EditTaskScreen : ActivityScreen<AppScreens.EditTask>() {
    ...
    override fun InitView(
        ...
        var selectedHour by remember {
            mutableStateOf(
                task.dueDate?.toLocalDateTime(TimeZone.currentSystemDefault())?.hour ?: 12
            )
        }
        var selectedMinute by remember {
            mutableStateOf(
                task.dueDate?.toLocalDateTime(TimeZone.currentSystemDefault())?.minute ?: 0
            )
        }
